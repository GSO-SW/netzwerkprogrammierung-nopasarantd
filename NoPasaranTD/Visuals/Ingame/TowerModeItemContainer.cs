...
namespace NoPasaranTD.Visuals.Ingame
{
    public class TowerModeItemContainer : ItemContainer<TowerTargetMode>
    {
        ...
        private readonly SolidBrush normalBackground = new SolidBrush(Color.FromArgb(159, 161, 166));
        private readonly SolidBrush selectedBackground = new SolidBrush(Color.FromArgb(99, 124, 186));
        private readonly SolidBrush hoverBackground = new SolidBrush(Color.FromArgb(145, 155, 179));
        private readonly Font textFont = GuiComponent.StandartText1Font;
